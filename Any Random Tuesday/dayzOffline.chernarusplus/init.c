...
// Non-VIP Loadout (Default Loadout)
	...
	{
		ref TStringArray pantsArray = {"Jeans_Blue","Jeans_BlueDark","CargoPants_Beige","CargoPants_Black","Jeans_Black","CargoPants_Green"};	
		ref TStringArray shoesArray = {"HikingBoots_Brown","MilitaryBoots_Redpunk","JungleBoots_Green","CombatBoots_Black","HikingBootsLow_Grey","WorkingBoots_Yellow"};	
		ref TStringArray glovesArray = {"WorkingGloves_Brown","TacticalGloves_Black","LeatherGloves_Brown","WorkingGloves_Beige"};		
		ref TStringArray backpackArray = {"AliceBag_Black","AssaultBag_Green","CoyoteBag_Brown","DryBag_Blue","HuntingBag","MountainBag_Red"};
		ref TStringArray knifeArray  = {"HandSaw","Hacksaw","HuntingKnife","CombatKnife","Cleaver"};
		ref TStringArray meleeArray = {"FirefighterAxe","Crowbar","Pipe","SledgeHammer","BaseballBat","Machete"};
		ref TStringArray gunArray = {"Magnum","Repeater","SawedoffIzh43Shotgun","Izh43Shotgun","Mp133Shotgun","Longhorn","B95"};
		...
		player.GetInventory().CreateInInventory("Lunchmeat");
		player.GetInventory().CreateInInventory("Apple");
		player.GetInventory().CreateInInventory("Ammo_357");
		...
		ItemBase light = player.GetInventory().CreateInInventory("Flashlight");
		light.GetInventory().CreateAttachment("Battery9V");
		ItemBase gun = player.GetInventory().CreateInInventory(gunArray.GetRandomElement());
